        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dayoff_1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dayoff_2 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeavingTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendance_Leavings", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Attendance_Leavings_Employees_Emp_ID",
                        column: x => x.Emp_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_Leavings_Emp_ID",
